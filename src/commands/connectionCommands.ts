...
export async function addConnectionCommand(
    ...
    try {
        ...
        const config: OpcuaConnectionConfig = {
            ...
            clientCertificatePath: result.authType === 'Certificate' ? result.clientCertificatePath : undefined,
            clientPrivateKeyPath: result.authType === 'Certificate' ? result.clientPrivateKeyPath : undefined
        };
...
export async function editConnectionCommand(
    ...
    try {
        ...
        let clientCertificatePath: string | undefined;
        let clientPrivateKeyPath: string | undefined;
        ...
        if (result.authType === 'UserPassword') {
            ...
            clientCertificatePath = result.clientCertificatePath ?? existingConfig.clientCertificatePath;
            clientPrivateKeyPath = result.clientPrivateKeyPath ?? existingConfig.clientPrivateKeyPath;
        }
        ...
        const updatedConfig: OpcuaConnectionConfig = {
            ...
            clientCertificatePath: result.authType === 'Certificate' ? clientCertificatePath : undefined,
            clientPrivateKeyPath: result.authType === 'Certificate' ? clientPrivateKeyPath : undefined
        };
